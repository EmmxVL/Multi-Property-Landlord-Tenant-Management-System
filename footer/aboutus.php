...
<main class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 p-6">
  <div class="bg-white/90 backdrop-blur-md rounded-3xl shadow-lg border border-slate-200 max-w-3xl w-full p-10 text-center">
    <h1 class="text-3xl font-bold text-blue-900 mb-4">About Us</h1>
    <p class="text-slate-700 text-sm leading-relaxed">
      Unitly is a modern property management system designed to simplify the lives of both landlords and tenants.
      Our mission is to create a smooth, transparent, and efficient communication platform that makes rental
      management easier, smarter, and more secure.
    </p>
    <p class="text-slate-700 text-sm leading-relaxed mt-3">
      Built by dedicated students from <strong>Batangas State University</strong>, Unitly embodies innovation, collaboration,
      and reliability — bringing digital solutions to real-world housing needs.
    </p>
