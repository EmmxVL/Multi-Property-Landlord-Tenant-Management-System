...
<main class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 p-6">
  <div class="bg-white/90 backdrop-blur-md rounded-3xl shadow-lg border border-slate-200 max-w-4xl w-full p-10">
    <h1 class="text-3xl font-bold text-blue-900 mb-4 text-center">Cookie Policy</h1>
    <p class="text-slate-700 text-sm leading-relaxed mb-3">
      Unitly uses cookies to enhance your experience, improve functionality, and provide analytics on platform usage.
    </p>
    <ul class="list-disc pl-6 text-slate-700 text-sm space-y-2">
      <li>Cookies store session data to keep you logged in securely.</li>
      <li>They help us improve website performance and user navigation.</li>
      <li>You can disable cookies in your browser, but some features may stop working properly.</li>
    </ul>
