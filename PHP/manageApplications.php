...
require_once "dbConnect.php"; // Corrected path
...
try {
    // *** THIS IS THE FIX ***
    // Added "AND ur.role_id = 1" to ONLY show pending Landlords.
    $stmt = $db->prepare("
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen font-sans flex flex-col">
    <?php include '../../assets/header.php'; // Corrected path ?>
        ...
        <section class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div class="flex items-center space-x-3 mb-4 sm:mb-0">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-slate-800">Manage Landlord Applications</h3>
                        <p class="text-slate-600 text-sm">Approve or reject new landlord applications</p>
                    </div>
                </div>
                <a href="dashboard/admin_dashboard.php" class="text-sm text-blue-600 hover:underline"> <!-- Corrected path -->
                        ...
                        <tr class="border-b border-slate-100 hover:bg-slate-50 transition-colors duration-150">
                            ...
                            <td class="py-4 px-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="view_application.php?id=<?= $app['user_id']; ?>" class="inline-flex items-center px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-medium rounded-lg transition">
                                        View Details
                                    </a>
            ...
            <div class="text-center py-12">
                ...
                <p class="text-slate-500">New landlord applications will appear here.</p>
            </div>
            <?php endif; ?>
        </section>
    </main>
        ...
        function confirmAction(userId, action) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `handleApplication.php?id=${userId}&action=${action}`; // Corrected path
                }
            });
        }
    </script>
